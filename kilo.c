...
#define ROW_OUT_OF_BOUNDS(row, numrows) ((row) < 0 || (row) > (numrows))
...
void handle_window_change(int signum);
...
void editor_insert_row(int at, char *s, size_t len)
{
    if ROW_OUT_OF_BOUNDS(at, E.numrows) return;
